    ...
    <main>
        <article>
            ...
            <section class="conteudo">
                <h3>Assinatura</h3>
                <div class="container__pai" id="assinatura">
                    <div class="container__filho">
                        <p>Plano Premium</p>
                        <p>Resolução de vídeo 4K, assistir sem anúncios e muito mais.</p>
                    </div>
                    <hr>
                    <div class="container__filho">
                        <a href="planos.php">
                ...
                <h3 class="inf__pagamento__titulo">Informações de pagamento</h3>
                <div class="container__pai" id="inf__pagamento">
                    <div class="container__filho">
                        <p>Próximo pagamento</p>
                        <div class="container__neto">
                    ...
                    <div class="container__filho">
                        <a href="#">
                            <p>Ver histórico de pagamento</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/>
                            </svg>
                        </a>
